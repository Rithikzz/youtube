import { Bell, Loader2, Menu, Mic, Search, VideoIcon } from "lucide-react";
...
const Header = () => {
  const { user, logout, onGoogleSuccess, isSigningIn, setIsSigningIn } = useUser();
    ...
    <header className="flex items-center justify-between px-4 py-2 bg-white border-b">
      ...
      <div className="flex items-center gap-1 md:gap-2">
        {user ? (
          ...
          <Button
            className="flex items-center gap-2 text-sm font-medium bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 shadow-sm"
